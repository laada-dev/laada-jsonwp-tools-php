...
function laada_wp_config($root_dir)
{
  ...
  if (is_dir($root_dir) && is_dir($app_dir)) {
    ...
    define('UPLOADS', env('UPLOADS', '../public/media'));
    ...
    define('LAADA_BACKEND_REQUEST_TIMEOUT', env('LAADA_BACKEND_REQUEST_TIMEOUT', 60));
    define('LAADA_BACKEND_BASIC_AUTH_USER', env('LAADA_BACKEND_BASIC_AUTH_USER'));
    define('LAADA_BACKEND_BASIC_AUTH_PASSWORD', env('LAADA_BACKEND_BASIC_AUTH_PASSWORD'));

    define('LAADA_API_BASIC_AUTH_USER', env('LAADA_API_BASIC_AUTH_USER'));
    define('LAADA_API_BASIC_AUTH_PASSWORD', env('LAADA_API_BASIC_AUTH_PASSWORD'));
    ...
    define('LAADA_REQUEST_TIMEOUT', env('LAADA_REQUEST_TIMEOUT', 1800));
